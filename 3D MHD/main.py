'''
####################################################################################################
3D Magnetohydrodynamic Equations
Carolyn Wendeln
06/24/2024
####################################################################################################

The 3D Magnetohydrodynamic Equations are given by
...
G(q) = |        ρu_yu_z - B_yB_z          |
       ...
       |        ρu_zu_x - B_zB_x          |
       |        ρu_zu_y - B_zB_y          |
H(q) = | ρu_zu_z + p + 0.5*∥B∥^2 - B_zB_z  |
       | u_z(E + p + 0.5*∥B∥^2) - B_z(u·B) |
       |        u_zB_x - u_xB_z           |
       |        u_zB_y - u_yB_z           |
       |               0                  |
